        ...
        private void DgvIpList_CellMouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            switch (host)
            {
                ...
                case "xvcf2.xboxlive.com":
                    ...
                    tsmUseIPPS.Visible = tsmUseIPEaBattleEpic.Visible = tsmUseIPNS.Visible = false;
                    break;
                ...
                case "ares.dl.playstation.net":
                    tsmUseIPXbox.Visible = tsmUseIPApp.Visible = tsmUseIPXboxApp.Visible = tsmUseIPEaBattleEpic.Visible = tsmUseIPNS.Visible = false;
                ...
                case "blzddist1-a.akamaihd.net":
                    ...
                    tsmUseIPEaBattleEpic.Visible = tsmUseIPNS.Visible = true;
                    break;
                default:
                    tsmUseIPXbox.Visible = tsmUseIPApp.Visible = tsmUseIPXboxApp.Visible = tsmUseIPPS.Visible = tsmUseIPEaBattleEpic.Visible = tsmUseIPNS.Visible = false;
                    break;
            }
            contextMenuStrip1.Show(MousePosition.X, MousePosition.Y);
        }
                ...
                case "blzddist1-a.akamaihd.net":
                    {
                        ...
                        LinkLabel lb2 = new LinkLabel()
                        {
                            Tag = "http://blzddist1-a.akamaihd.net/tpr/odin/data/a3/37/a337efef9d8e152467fc745af060e734",
        ...
        private void ButSpeedTest_Click(object sender, EventArgs e)
        {
            if (!isSpeedTest)
            {
                ...
                */
                ...
                ckbChinaTelecom.Enabled = ckbChinaUnicom.Enabled = ckbChinaMobile.Enabled = ckbHK.Enabled = ckbTW.Enabled = ckbJapan.Enabled = ckbKorea.Enabled = ckbUS.Enabled = ckbOther.Enabled = linkExportIP.Enabled = cbImportIP.Enabled = linkImportIPManual.Enabled = flpTestUrl.Enabled = tbDlUrl.Enabled = false;
            ...
            else
            {
                ...
                ckbChinaTelecom.Enabled = ckbChinaUnicom.Enabled = ckbChinaMobile.Enabled = ckbHK.Enabled = ckbTW.Enabled = ckbJapan.Enabled = ckbKorea.Enabled = ckbUS.Enabled = ckbOther.Enabled = linkExportIP.Enabled = cbImportIP.Enabled = linkImportIPManual.Enabled = flpTestUrl.Enabled = tbDlUrl.Enabled = true;
